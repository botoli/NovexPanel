...
const LeftPanel = observer(() => {
  ...
  const getIcon = (name: string) => {
    switch (name.toLowerCase()) {
      ...
      case "applications":
        return (
          <Icon icon="material-symbols:deployed-code-sharp" fontSize="30" />
        );
      case "activity":
        return (
          <Icon icon="material-symbols:browse-activity-rounded" fontSize="30" />
        );
      case "network":
        return <Icon icon="mdi:server-network" fontSize="30" />;
      case "domains":
